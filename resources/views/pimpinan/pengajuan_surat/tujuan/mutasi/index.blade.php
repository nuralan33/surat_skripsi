                            ...
                            <table class="table table-sm table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($item->status == '1')
                                            <a href="{{ route('p_tujuan.mutasi.show', $item->id) }}" target="_blank" class="btn btn-sm btn-info">Belum Disetujui
                                                -
                                                Lihat
                                                Surat</a>
                                            ...
                                            <a href="{{ route('p_tujuan.mutasi.show', $item->id) }}" target="_blank" class="btn btn-sm btn-danger">Ditolak -
                                                Lihat
                                                Surat</a>
                                            @else
                                            <a href="{{ route('p_tujuan.mutasi.show', $item->id) }}" target="_blank" class="btn btn-sm btn-success">Disetujui -
                                                Lihat
                                                Surat</a>
                                            @endif
                                        </td>
