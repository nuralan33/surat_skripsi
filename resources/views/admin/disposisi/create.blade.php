                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div style="float: right;">
                            <a href="{{route('pengajuan_surat.show',$pengajuan_surat->id)}}" target="_blank" class="btn btn-sm btn-primary">Detail Surat</a>
                        </div>
                    </div>

                    <div class="card-body">
                   
                        <form action="{{ route('disposisi.store',$pengajuan_surat->id) }}" method="POST">
                            @csrf
                            <div class="mb-3">
