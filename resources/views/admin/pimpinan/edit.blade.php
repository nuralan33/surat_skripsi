                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('pimpinan.update',$pimpinan->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="" placeholder="Nama" name="name" value="{{$pimpinan->name}}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="" placeholder="Jenis Jabatan" name="jenis_jabatan" value="{{$pimpinan->jenis_jabatan}}">
                            </div>
                            <div class="mb-3">
                                <label for="" class="form-label">No Telponan</label>
                                <input type="text" class="form-control" id="" placeholder="No Telepona" name="no_telp" value="{{$pimpinan->no_telp}}">
                            </div>
                            <div class="mb-3">
                                <label for="" class="form-label">Tanggal Daftar</label>
                                <input type="date" class="form-control" id="" placeholder="Tanggal Daftar" name="tgl_daftar" value="{{$pimpinan->tgl_daftar}}">
                            </div>
                            <div class="mb-3">
                                <label for="" class="form-label">E-Mail</label>
                                <input type="email" class="form-control" id="" placeholder="E-Mail" name="email" value="{{$pimpinan->email}}">
                            </div>
                            <div class="mb-3">
