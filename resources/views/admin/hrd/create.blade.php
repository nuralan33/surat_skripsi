                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('hrd.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="hidden" class="form-control" id="" placeholder="Nama" name="id_jabatan" value="4">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="" placeholder="No. Telpon" name="no_telp">
                            </div>
                            <div class="mb-3">
