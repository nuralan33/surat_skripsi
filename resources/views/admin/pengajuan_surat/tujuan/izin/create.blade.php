            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('tujuan.surat_izin.store')}}" method="POST">
                            @csrf
                            <div class="mb-3">
                                <label for="" class="form-label">No Surat</label>
                                <input type="text" class="form-control" id="" value="{{ $no_surat }}" readonly
                                    placeholder="No Surat" name="no_surat">
                                    <input type="hidden" class="form-control" id="" value="1" name="id_jenis_surat">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <a href="{{route('tujuan.surat_izin')}}" class="btn btn-sm btn-danger">Kembali</a>
