                        ...
                        <table class="table table-sm table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($item->status == '0')
                                        <a href="{{ route('h_tujuan.kenaikan.show', $item->id) }}" target="_blank" class="btn btn-sm btn-info">
                                            Lihat Surat
                                        </a>
                                        ...
                                        <a href="{{ route('h_tujuan.kenaikan.show', $item->id) }}" target="_blank" class="btn btn-sm btn-danger">Ditolak -
                                            Lihat
                                            Surat</a>
                                        @else
                                        <a href="{{ route('h_tujuan.kenaikan.show', $item->id) }}" target="_blank" class="btn btn-sm btn-success">Disetujui -
                                            Lihat
                                            Surat</a>
                                        @endif
                                    </td>
                        ...
                        <table class="table table-sm table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($item->status == '0')
                                        <a href="{{ route('disposisi.kenaikan', $item->id) }}" class="btn btn-sm btn-primary">Disposisi</a>
                                        <a href="{{ route('h_tujuan.kenaikan.show', $item->id) }}" target="_blank" class="btn btn-sm btn-info">
                                            Lihat Surat
                                        </a>
