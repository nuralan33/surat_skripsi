                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                ...
                                <div class="col-auto">
                                    ...
                                    <a href="{{route('h_tujuan.surat_izin')}}" class="btn btn-sm btn-primary">Lihat</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card border-left-success shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                ...
                                <div class="col-auto">
                                    <a href="{{route('h_tujuan.mutasi')}}" class="btn btn-sm btn-success">Lihat</a>
                                    {{-- <i class="fas fa-calendar fa-2x text-gray-300"></i> --}}
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card border-left-dark shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                ...
                                <div class="col-auto">
                                    <a href="{{route('h_tujuan.kinerja')}}" class="btn btn-sm btn-dark">Lihat</a>
                                    {{-- <i class="fas fa-calendar fa-2x text-gray-300"></i> --}}
                                </div>
                            </div>
                        </div>
