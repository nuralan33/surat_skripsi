...
class PengajuanController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('hrd.pengajuan_surat.index', compact('pengajuan_surat', 'no','pegawai'));
    }
    ...
    public function create()
    {
        ...
        $pegawai = User::all();
        return view('hrd.pengajuan_surat.create',compact('pegawai','jenis_surat'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('hrd/h_pengajuan_surat?status=sukses');
    }
    ...
    public function edit($id)
    {
        ...
        $pegawai = User::all();
        $pengajuan_surat = PengajuanSurat::find($id);
        return view('hrd.pengajuan_surat.edit',compact('pengajuan_surat','jenis_surat','pegawai'));
    }
